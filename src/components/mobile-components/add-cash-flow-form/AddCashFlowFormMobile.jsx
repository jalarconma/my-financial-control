...
import { FlowType } from '../../../models/index';
import useForm from '../../../hooks/use-form/use-form';
import validate from '../../utils/cashflow-validations';

import styles from './AddCashFlowFormMobile.module.scss';

const AddCashFlowFormMobile = ({ onClose, onAdd }) => {
  const {
    formState,
    inputChangeHandler,
    inputBlurHandler,
...
export default AddCashFlowFormMobile;